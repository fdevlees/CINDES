...
def geomfiller(zma, geom, count):
    ...
    geom[0][0] = zma[0][0]
    print("length of zma: "+str(len(zma)))
    print("length of nageom: "+str(nageom))
...
def substituter2(group, geom0, count):
    ...
    if len(group) == 7:
        ...
        #elif group == ['C', 'C', 'O', 'O', 'Et']:
        #    zma = [['C', 1, '1.54000000'],
        #           ['O', 2, '1.23026900', 1, '130.07326412', 0, '0.0023405'],
        #           ['O', 2, '1.35698563', 1, '112.29471685', 3, '-179.99688035'],
        #           ['C', 4, '1.43000000', 2, '110.60791865', 3, '0.00226909'],
        #           ['H', 5, '1.07000000', 4, '109.47120255', 2, '-60.00104809'],
        #           ['H', 5, '1.07000000', 4, '109.47123134', 2, '59.99894452'],
        #           ['C', 5, '1.54000000', 4, '109.47120255', 2, '179.99893712'],
        #           ['H', 8, '1.07000000', 5, '109.47120255', 4, '179.88705609'],
        #           ['H', 8, '1.07000000', 5, '109.47120255', 4, '-60.11292912'],
        #           ['H', 8, '1.07000000', 5, '109.47123134', 4, '59.88706348']
        #           ]
        #    if dihedral:
        #        zma[1][6] = dihedral
        #    geom = geomfiller(zma, geom, count)
        #    count += len(zma)
        #    print("CCOOEt:  "+str(count))
    ...
    # when length == 4 then it is an amine or nitro group
        ...
        if group == ['C', 'C', 'C', 'H']:
            ...
            geom = geomfiller(zma, geom, count)
            count += len(zma)
        elif group in [['C', 'Me', 'Me', 'Me']]:
            #print "tBu  group"
            zma = [['C', 1, '1.5403668'],
                   ['C', 2, '1.5401543', 1, '109.4739434', 0, '120.1'],
                   ['H', 3, '1.0971262', 2, '111.1587085', 1, '-60.0005846'],
                   ['H', 3, '1.0971197', 2, '111.1599672', 1, '60.0026568'],
                   ['H', 3, '1.0971621', 2, '111.1598909', 1, '179.9993961'],
                   ['C', 2, '1.5401516', 1, '109.4716650', 3, '120.0015890'],
                   ['H', 7, '1.0971222', 2, '111.1577947', 1, '59.9864322'],
                   ['H', 7, '1.0971642', 2, '111.1577175', 1, '179.9823987'],
                   ['H', 7, '1.0971280', 2, '111.1597709', 1, '-60.0180261'],
                   ['C', 2, '1.5401581', 1, '109.4738993', 7, '119.9997398'],
                   ['H', 11, '1.0971603', 2, '111.1548443', 1, '179.9907868'],
                   ['H', 11, '1.0971251', 2, '111.1649607', 1, '-60.0095877'],
                   ['H', 11, '1.0971144', 2, '111.1565121', 1, '59.9978819']]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            count += len(zma)
        elif group == ['C', 'Ph', 'Pr', 'Pr']:
            #print "diPP  group"
            zma = [['C', 1, '1.5202145'],
                   ['C', 2, '1.4163313', 1, '120.9724852', 0, '85.1'],
                   ['C', 2, '1.4159591', 1, '119.2874538', 3, '179.8162073'],
                   ['C', 3, '1.4012031', 2, '118.9963017', 4, '2.6642918'],
                   ['C', 4, '1.3998022', 2, '119.3196510', 3, '-2.6889568'],
                   ['C', 5, '1.3907044', 3, '121.2898597', 2, '-0.8740098'],
                   ['H', 5, '1.0855085', 3, '119.6738105', 2, '179.3691725'],
                   ['H', 6, '1.0861021', 4, '119.7196591', 2, '-179.1923468'],
                   ['H', 7, '1.0871501', 5, '120.1872478', 3, '179.8301584'],
                   ['C', 3, '1.5316622', 2, '121.8340242', 4, '-178.7416644'],
                   ['H', 11, '1.0956653', 3, '107.9995398', 2, '29.0927769'],
                   ['C', 11, '1.5392507', 3, '113.8370436', 2, '146.3057451'],
                   ['H', 13, '1.0954390', 11, '111.5103106', 3, '-51.5191329'],
                   ['H', 13, '1.0959344', 11, '112.2828995', 3, '69.7802820'],
                   ['H', 13, '1.0962340', 11, '109.8021877', 3, '-171.3021141'],
                   ['C', 11, '1.5430312', 3, '110.9000254', 2, '-88.6753638'],
                   ['H', 17, '1.0955652', 11, '56.8325090', 3, '56.8325090'],
                   ['H', 17, '1.0970767', 11, '110.9586587', 3, '177.5574645'],
                   ['H', 17, '1.0966244', 11, '110.4396220', 3, '-62.7091039'],
                   ['C', 4, '1.5302620', 2, '121.4451495', 3, '178.8251888'],
                   ['H', 21, '1.0949634', 4, '108.1132596', 2, '-21.9518116'],
                   ['C', 21, '1.5396634', 4, '113.4416672', 2, '-139.3509817'],
                   ['H', 23, '1.0958369', 21, '112.2420196', 4, '-68.1985639'],
                   ['H', 23, '1.0954890', 21, '111.3750181', 4, '52.8426140'],
                   ['H', 23, '1.0964317', 21, '109.9828682', 4, '172.6721440'],
                   ['C', 21, '1.5428641', 4, '110.8558904', 2, '95.5809968'],
                   ['H', 27, '1.0970339', 21, '110.9510657', 4, '-177.2808406'],
                   ['H', 27, '1.0958631', 21, '111.5723768', 4, '-56.6734055'],
                   ['H', 27, '1.0965962', 21, '110.6145138', 4, '62.8935530']]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            count += len(zma)
        ...
        if group == ['C', 'Ph']:
            ...
            #print("Ethyl group")
            zma = [['C', 1, '1.5400000'],
                   ['C', 2, '1.5002500', 1, '110.7080933', 0, '0.0023405'],
                   ['H', 3, '1.1171373', 1, '91.1306062', 2,'-125.8901475'],
                   ['H', 3, '1.1171462', 2, '110.7248352',4, '119.9945406'],
                   ['H', 3, '1.1171403', 2, '110.7281844',4, '-119.9982952'],
                   ['H', 2, '1.1170383', 3, '110.7359237',4, '179.9967093'],
                   ['H', 2, '1.1171740', 3, '110.7070783',4, '-59.9974973']
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            #print("Propyl group")
            zma = [['C', 1, '1.5400000'],
                   ['C', 2, '1.5002500', 1, '110.7080933', 0, '90.1'],
                   ['H', 3, '1.1171373', 2, '110.7128328', 1,'59.9920410'],
                   ['H', 3, '1.1171403', 2, '110.7281844', 4, '-60.0062542'],
                   ['H', 2, '1.1170383', 1, '108.1957140', 3, '-121.5134038'],
                   ['H', 2, '1.1171740', 1, '108.1987133', 3, '121.4797303'],
                   ['C', 3, '1.5400000', 2, '110.7248352', 1, '179.9865817'],
                   ['H', 8, '1.0700000', 3, '109.4712026', 2, '179.9961976'],
                   ['H', 8, '1.0700000', 3, '109.4712026', 2, '-60.0037876'],
                   ['H', 8, '1.0700000', 3, '109.4712313', 2, '59.9962050'],
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            #print("Isopropyl group")
            zma = [['C', 1, '1.5400000'],
                   ['H', 2, '1.11717398', 1, '108.19871330', 0, '0.1'],
                   ['C', 2, '1.50025000', 1, '110.70809328', 3, '-121.47973035'],
                   ['H', 4, '1.11713735', 2, '110.71283282', 1, '59.99204104'],
                   ['H', 4, '1.11714029', 2, '110.72818440', 1, '-60.00625420'],
                   ['H', 4, '1.07000000', 2, '110.72483515', 1, '179.98658165'],
                   ['C', 2, '1.54000000', 1, '108.19571404', 4, '-121.51340378'],
                   ['H', 8, '1.07000000', 2, '109.47120255', 1, '-179.46863248'],
                   ['H', 8, '1.07000000', 2, '109.47120255', 1, '-59.46861768'],
                   ['H', 8, '1.07000000', 2, '109.47123134', 1, '60.53137492']
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            zma = [['C', 1, '1.54000000'],
                   ['O', 2, '1.23026900', 1, '130.07326412', 0, '90.1'],
                   ['O', 2, '1.35698563', 1, '112.29471685', 3, '-179.99688035'],
                   ['C', 4, '1.43000000', 2, '110.60791865', 3, '0.00226909'],
                   ['H', 5, '1.07000000', 4, '109.47120255', 2, '-60.00104809'],
                   ['H', 5, '1.07000000', 4, '109.47123134', 2, '59.99894452'],
            ...
            zma = [['C', 1, '1.54000000'],
                   ['C', 2, '2.50275510', 1, '143.80349813', 0, '90.1'],
                   ['C', 3, '1.51543497', 2, '89.98626360', 1, '-124.50873892'],
                   ['C', 4, '1.51512522', 3, '111.26574203', 2, '-27.63830552'],
                   ['H', 3, '1.12087116', 2, '143.81671457', 5, '142.17629115'],
                   ['H', 2, '1.12177478', 5, '93.29187215', 4, '-109.46242584'],
                   ['H', 4, '1.12176062', 3, '109.41106707', 2, '93.39196196'],
                   ['H', 4, '1.12091101', 3, '109.58676541', 2, '-148.97589276'],
                   ['H', 5, '1.12095758', 4, '109.55885178', 3, '176.61579480'],
                   ['H', 5, '1.12181557', 4, '109.38713435', 3, '-65.80639557'],
                   ['H', 3, '1.12168148', 2, '93.23141657', 5, '-91.84608791'],
                   ['S', 2, '1.51498514', 5, '34.35303231', 4, '130.16143463'],
                   ['S', 2, '1.51510600', 13, '111.30936835', 5, '55.08231287']
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            zma = [['C', 1, '1.54000000'],
                   ['C', 2, '2.40920176', 1, '151.46744001', 0, '90.1'],
                   ['C', 2, '1.39608081', 1, '120.59880817', 3, '0.06179123'],
                   ['C', 2, '1.39597659', 4, '118.77921539', 3, '-0.01128545'],
                   ['C', 5, '1.40696295', 2, '118.50535494', 4, '0.00427100'],
                   ['N', 3, '1.34720531', 4, '123.48284293', 2, '0.01004529'],
                   ['H', 3, '1.10458350', 7, '115.72000132', 6, '-179.99845045'],
                   ['H', 4, '1.09742843', 3, '120.36345553', 7, '179.99407098'],
                   ['H', 5, '1.09743617', 2, '121.13280189', 4, '-179.99438108'],
                   ['H', 6, '1.10465832', 5, '120.79346599', 2, '179.99333106']
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            zma = [['C', 1, '1.12093060'],
                   ['C', 2, '1.51510601', 1, '109.57716274', 0, '70.1'],
                   ['C', 3, '1.51517951', 2, '111.36252427', 1, '-176.55289616'],
                   ['O', 4, '1.51543496', 3, '111.24127580', 2, '55.25714293'],
                   ['C', 5, '1.51512522', 4, '111.26574211', 3, '-55.23663794'],
                   ['C', 2, '1.51498514', 1, '109.57492453', 3, '-122.39956099'],
                   ['H', 4, '1.12087116', 3, '109.59001055', 2, '176.59526998'],
                   ['H', 3, '1.12176819', 2, '109.39681609', 1, '-55.51035203'],
                   ['H', 3, '1.12099605', 2, '109.55953671', 1, '62.07808645'],
                   ['H', 2, '1.12177478', 1, '107.48634660', 7, '-118.80150342'],
                   ['H', 6, '1.12095759', 5, '109.55885143', 4, '176.61579489'],
                   ['H', 6, '1.12181557', 5, '109.38713401', 4, '-65.80639599'],
                   ['H', 7, '1.12176020', 2, '109.41082788', 1, '55.39805306'],
                   ['H', 7, '1.12097986', 2, '109.56859844', 1, '-62.21329761'],
                   ['H', 4, '1.12168148', 3, '109.42519792', 2, '-65.75731451']
                   ]
           # zma = [['C', 1, '1.12093060'],
           #        ['C', 2, '1.51510600', 1, '109.57716262', 0, '0.0023405'],
           #        ['C', 3, '1.51517951', 2, '111.36252447', 1, '-176.55289631'],
           #        ['C', 4, '2.50153800', 3, '89.94825132', 2, '27.63153158'],
           #        ['C', 2, '1.51498514', 3, '111.30936835', 4, '-55.19282652'],
           #        ['H', 4, '1.12087116', 3, '109.59001104', 2, '176.59526965'],
           #        ['H', 3, '1.12176819', 2, '109.39681635', 6, '65.84971766'],
           #        ['H', 3, '1.12099605', 2, '109.55953690', 6, '-176.56184324'],
           #        ['H', 2, '1.12177478', 6, '109.40750597', 5, '-65.94975705'],
           #        ['H', 5, '1.12085758', 4, '143.83980581', 3, '124.62096684'],
           #        ['H', 5, '1.12181557', 4, '93.19556893', 3, '-109.48701870'],
           #        ['H', 6, '1.12176019', 2, '109.41082787', 3, '-65.96332262'],
           #        ['H', 6, '1.12097986', 2, '109.56859847', 3, '176.42532586'],
           #        ['H', 4, '1.12168148', 3, '109.42519797', 2, '-65.75731388'],
           #        ['O', 5, '1.51512522', 4, '34.37113382', 3, '130.03041289']
           #        ]
            #zma = [['C', 1, '1.54000000'],
            #       ['C', 2, '1.51510600', 1, '109.57716262', 0, '0.0023405'],
            #       ['C', 3, '1.51517951', 2, '111.36252447', 1, '-176.55289631'],
            ...
            #       ['H', 3, '1.12176819', 2, '109.39681635', 6, '65.84971766'],
            #       ['H', 3, '1.12099605', 2, '109.55953690', 6, '-176.56184324'],
            #       ['H', 2, '1.12177478', 6, '109.40740597', 5, '-65.94975705'],
            #       ['H', 5, '1.12095758', 4, '143.83980581', 3, '124.62096684'],
            #       ['H', 5, '1.12181557', 4, '93.19556893', 3, '-109.48701870'],
            #       ['H', 6, '1.12176019', 2, '109.41082787', 3, '-65.96332262'],
            #       ['H', 6, '1.12097986', 2, '109.56859847', 3, '176.42532586'],
            #       ['H', 4, '1.12168148', 3, '109.42519797', 2, '-65.75731388'],
            ...
            zma = [['C', 1, '1.09951031'],
                   ['C', 2, '1.39516000', 1, '119.99722313', 0, '90.1'],
                   ['C', 3, '1.39471206', 2, '120.00863221', 1, '-179.97292593'],
                   ['C', 4, '1.39542701', 3, '119.99416459', 2, '-0.05684321'],
                   ['C', 5, '1.39482508', 4, '119.99399231', 3, '0.03411439'],
                   ['C', 2, '1.39482907', 1, '120.00431986', 3, '179.99472567'],
                   ['H', 4, '1.09968019', 3, '120.01279489', 2, '179.96185208'],
                   ['H', 6, '1.09976099', 5, '120.01134336', 4, '-179.99951388'],
                   ['C', 5, '1.54000001', 4, '119.98114194', 3, '-179.99643591'],
                   ['H', 10, '1.0700000', 5, '109.47120185', 4, '-88.60046236'],
                   ['H', 10, '1.0700000', 5, '109.47120185', 4, '31.39955278'],
                   ['H', 10, '1.0700000', 5, '109.47123118', 4, '151.39954564'],
                   ['C', 7, '1.5399999', 2, '120.00799694', 1, '-0.00555022'],
                   ['H', 14, '1.0700000', 7, '109.47120252', 2, '121.89928963'],
                   ['H', 14, '1.0700000', 7, '109.47120278', 2, '-118.10069622'],
                   ['H', 14, '1.0700000', 7, '109.47123144', 2, '1.89928963'],
                   ['C', 3, '1.54000001', 2, '119.98077053', 1, '-0.05202575'],
                   ['H', 18, '1.0700000', 3, '109.47120226', 2, '-33.49866977'],
                   ['H', 18, '1.0700000', 3, '109.47120309', 2, '86.50134561'],
                   ['H', 18, '1.0700000', 3, '109.47123142', 2, '-153.49866151'],
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            zma = [['N', 1, '1.4700000'],
                   ['C', 2, '1.4640435', 1, '116.6850200', 0, '90.1'],
                   ['C', 2, '1.5008639', 1, '112.5537875', 3, '120.6812737'],
                   ['C', 3, '1.5470450', 2, '98.7565221',  1, '170.3088443'],
                   ['H', 3, '1.0700000', 2, '112.1957565', 1, '53.2234167'],
                   ['H', 3, '1.0700000', 2, '112.8899114', 1, '-68.9305172'],
                   ['C', 5, '1.4980956', 3, '95.8355803',  1, '-51.5407743'],
                   ['H', 4, '1.0700000', 3, '130.4222338', 1, '88.9117472'],
                   ['H', 4, '1.0700000', 3, '117.4156571', 1, '-68.1887446'],
                   ['H', 5, '1.0700000', 3, '111.9711831', 1, '66.1972069'],
                   ['H', 5, '1.0700000', 3, '114.7948924', 1, '-171.0614305'],
                   ['H', 8, '1.0700000', 5, '117.2287120', 3, '173.1632536'],
                   ['H', 8, '1.0700000', 5, '105.5691916', 3, '-65.9255887']]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            count += len(zma)
            ...
            zma = [['C', 1, '1.5400000'],
                   ['C', 2, '1.40139999', 1, '119.99999972', 0, '90.1'],
                   ['C', 2, '1.40140000', 1, '119.99999978', 3, '180.00000000'],
                   ['C', 3, '1.40140000', 2, '119.99999993', 1, '180.00000000'],
                   ['H', 3, '1.07000000', 2, '120.00000063', 1, '-0.00000000'],
                   ['C', 4, '1.40140000', 2, '119.99999963', 1, '-180.00000000'],
                   ['H', 4, '1.07000000', 2, '120.00000048', 1, '-0.00000000'],
                   ['C', 5, '1.40140000', 3, '120.00000002', 2, '0.00000000'],
                   ['H', 5, '1.07000000', 3, '119.99999986', 2, '180.00000000'],
                   ['H', 7, '1.07000000', 4, '120.00000015', 2, '180.00000000'],
                   ['N', 9, '1.47000000', 5, '120.00000025', 3, '-180.00000000'],
                   ['O', 12, '1.23760000', 9, '119.99999951', 5, '0.00000000'],
                   ['O', 12, '1.23759999', 9, '120.00000010', 5, '-180.00000000'],
                   ]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            ...
            #print "adama group"
            zma = [['C', 1, '1.5348329'],
                   ['H', 2, '1.1014302', 1, '106.5109907', 0, '115.1'], #115.1 
                   ['C', 2, '1.5520468', 1, '113.6755039', 3, '-117.6972752'],
                   ['C', 2, '1.5518988', 4, '108.3561768', 3, '-115.2376833'],                   
                   ['H', 4, '1.0991511', 2, '109.1540510', 5, '178.8353233'],
                   ['C', 4, '1.5448338', 2, '110.9124498', 5, '58.0906616'],
                   ['C', 4, '1.5445012', 2, '108.9511611', 5, '-61.6953799'],
                   ['H', 5, '1.0991471', 2, '109.1655034', 4, '-178.8365497'],
                   ['C', 5, '1.5449318', 2, '110.9085165', 4, '-58.0889979'],
                   ['C', 5, '1.5446110', 2, '108.9497653', 4, '61.6933315'],
                   ['H', 7, '1.0990527', 4, '109.5447779', 2, '179.4268392'],
                   ['H', 7, '1.0975356', 4, '110.8436244', 2, '62.2409590'],
                   ['C', 10, '1.5436213', 5, '109.7638237', 2, '59.7020137'],
                   ['H', 8, '1.0990001', 4, '110.0332622', 2, '-60.5248409'],
                   ['H', 8, '1.0990885', 4, '110.0431428', 2, '-177.9852440'],
                   ['C', 11, '1.5433621', 5, '109.7930155', 2, '-60.8183825'],
                   ['H', 10, '1.0975474', 5, '110.8393041', 2, '-62.2356894'],
                   ['H', 10, '1.0990284', 5, '109.5427923', 2, '-179.4180439'],
                   ['H', 11, '1.0990038', 5, '110.0312031', 2, '60.5213246'],
                   ['H', 11, '1.0990803', 5, '110.0378981', 2, '177.9808948'],
                   ['H', 14, '1.0983552', 10, '109.6108342', 5, '-179.6749526'],
                   ['C', 14, '1.5431832', 10, '109.3544511', 5, '60.1558863'],
                   ['H', 17, '1.0983383', 11, '109.6069343', 5, '179.5407087'],
                   ['H', 23, '1.0991138', 14, '110.0846583', 10, '61.3947275'],
                   ['H', 23, '1.0991098', 14, '110.0832449', 10, '178.9540225']]
            if dihedral:
                zma[1][6] = dihedral
            geom = geomfiller(zma, geom, count)
            count += len(zma)
