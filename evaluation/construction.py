...
def substituter2(group, geom0, count):
    ...
    # when length == 4 then it is an amine or nitro group
        ...
        if group == ['C', 'Ph']:
            ...
            zma = [['C', 1, '1.5400000'],
                   ['H', 2, '1.11717398', 1, '108.19871330', 0, '0.0023405'],
           ...
           # count += len(zma)
            ...
            zma = [['C', 1, '1.54000000'],
                   ['C', 2, '2.50275510', 1, '143.80349813', 0, '0.0023405'],
            ...
            zma = [['C', 1, '1.54000000'],
                   ['C', 2, '2.40920176', 1, '151.46744001', 0, '0.0023405'],
            ...
            zma = [['C', 1, '1.12093060'],
                   ['C', 2, '1.51510601', 1, '109.57716274', 0, '0.0023405'],
           ...
           #        ]
            ...
            zma = [['C', 1, '1.09951031'],
                   ['C', 2, '1.39516000', 1, '119.99722313', 0, '30.1'],
