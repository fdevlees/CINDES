...
Main developer: Jos L. Teunissen (Vrije Universiteit Brussel)
Co-developers: Eline Desmedt, David Smets (Vrije Universiteit Brussel)

Email correspondence: freija.de.vleeschouwer@vub.be

**Related publications**

Jos L. Teunissen, Frank De Proft, Freija De Vleeschouwer, Tuning the HOMO-LUMO Gap of Small Diamondoids Using Inverse Molecular Design. _J. Chem. Theory Comput._, **2017**, _13_, 1351–1365.

Jos L. Teunissen, Frank De Proft, Freija De Vleeschouwer, Acceleration of Inverse Molecular Design by Using Predictive Techniques. _J. Chem. Inf. Model._, **2019**, _59_, 2587-2599.
